...
public class Exam4 {
    ...
    public static void main(String[] args) {
        ...
        // 멤버메소드(); // error // static 갖는 변수/메소드(main)는 우선할당이므로 객체가 아닌 멤버메소드를 모른다.
        Exam4 exam4 = new Exam4();
        exam4.멤버메소드();
        정적메소드(); // main메소드가 static 갖고 정적메소드도 static 갖기 때문에 서로 알고 있는 상태 <객체필요없음>
