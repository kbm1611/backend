...
public class Exam1 {
    public static void main(String[] args) {
        ...
        // [4] 사용법
            ...
            // -> < > 괄호는 제네릭타입으로 리스트 안에 저장 할 *항목들의타입*
        // -> 제네릭타입은 기본타입 불가능하므로 int -> Integer클래스 변경해서 작성 ( 8개 타입 )
        ...
        System.out.println( 리스트변수명 ); // [유재석, 강호동, 신동엽]
            ...
            //인덱스란? 배열/리스트에 요소/값들이 저장된 순서 번호, 0번 시작
        리스트변수명.add ( 1, "서장훈");
        System.out.println("리스트변수명 = " + 리스트변수명); // [유재석, 서장훈, 강호동, 신동엽]
        ...
        System.out.println( 리스트변수명.get(0)); // 강호동
            // 8. 요소 삭제 : .remover( 인덱스 ) : 특정한 인덱스의 요소 삭제
        리스트변수명.remove(1); // 1번 인덱스의 요소 삭제
        System.out.println("리스트변수명 = " + 리스트변수명);
            // 9. 요소 찾기 : indexOf( 찾을 값 ) : 찾을 값이 존재하면 인덱스 반환, 없으면 -1 반환한다.
        int 찾은결과 = 리스트변수명.indexOf("강호동");
        System.out.println("찾은결과 = " + 찾은결과);
            // 10. 요소 찾기2 : .contains( 찾을 값 ) : 찾을 값이 존재하면 true, 없으면 false 반환한다.
        ...
        for( String str : 리스트변수명){
            ...
            // 11. 요소 전체 삭제 : .clear()
        리스트변수명.clear();
            // 12. 요소 존재 여부 : .isEmpty() : 리스트내 요소가 하나도 없으면 true 없으면 false
