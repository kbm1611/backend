...
출력 예시: 성공 */
        ...
        System.out.print("첫 번째 점수:"); int score1 = scan.nextInt();
        System.out.print("두 번째 점수:"); int score2 = scan.nextInt();
...
출력 예시: 더 큰 수: 25 */
        ...
        int i2 = scan.nextInt();
        if (i1 >= i2) {
            System.out.println("더 큰 수:" + i1);
        } else {
            System.out.println("더 큰 수:" + i2);
        }
...
출력 예시: 여자 */
        System.out.print("주민등록번호(-포함) 13자리를 입력하세요:"); String rrn = scan.next();
...
점수를 입력하세요: 85
출력 예시: B등급 */
        System.out.print("점수를 입력하세요:"); int score3 = scan.nextInt();
        if( score3 >= 90 ){
...
출력 예시: 가을 */
        ...
        System.out.print("월(1~12)을 입력하세요:"); int month = scan.nextInt();
...
출력 예시: 가장 큰 수: 78 */
        ...
        System.out.print("첫 번째 정수:"); int int1 = scan.nextInt();
        System.out.print("두 번째 정수:"); int int2 = scan.nextInt();
        System.out.print("세 번째 정수:"); int int3 = scan.nextInt();
...
출력 예시: 4, 8, 17 */
        ...
        if(num1 > num2 ){ int temp = num1 ; num1 = num2 ; num2 = temp; }; //큰 수로 스왑
...
출력 예시: 플레이어1 승리 */
        ...
        System.out.print("플레이어1 (0:가위, 1:바위, 2:보):"); int rsp1 = scan.nextInt();
        System.out.print("플레이어2 (0:가위, 1:바위, 2:보):"); int rsp2 = scan.nextInt();
